...
helm upgrade --install gloo-mesh-enterprise gloo-mesh-enterprise/gloo-mesh-enterprise  -n gloo-mesh --version=1.1.0-beta16 --set licenseKey=${GLOO_MESH_LICENSE_KEY}  --set metricsBackend.prometheus.enabled=true   --set rbac-webhook.enabled=true
